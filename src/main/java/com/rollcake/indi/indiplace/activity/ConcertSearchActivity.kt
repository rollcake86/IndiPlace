...
class ConcertSearchActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        searchBtn.setOnClickListener {
            ...
            ServerNetworking.sendToMobileServer(this@ConcertSearchActivity, Request.Method.GET, AppApplication.DOMAIN + "/performance?location=" + locationString + "&genre=" + generString, null, null, object : ServerNetworking.getResult {
